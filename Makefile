...
CFLAGS_RASPBERRYPI4 = -Os -Idevices/rpi4/ -DGUPJE_BLOCK_SIZE=0x100
rpi4:
	...
	$(LD) -T devices/rpi4/linkscript.ld bin/rpi4/entry.o bin/rpi4/debugger.o -o bin/rpi4/debugger.elf --just-symbols=devices/rpi4/symbols.txt
